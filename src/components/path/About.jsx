      ...
      <div className="lg:grid lg:grid-cols-2 md:grid-cols-1 gap-10">
        ...
        <div className="text-left mt-5 lg:w-full">
          ...
          <p className="mt-3 text-left mb-2">
             <span className="text-2xl text-red-500 font-extrabold">I </span>'m experiencing in building full-stack web solutions
            using MongoDB, Express.js, React, and Node.js. My skills also
            include HTML, CSS, and JavaScript, along with various libraries and
            frameworks.
          </p>
          ...
          <div className="">
            ...
            <li className=" list-none  hover:text-emerald-500 hover:scale-105 text-lg  bg-gray-200 rounded-2xl mt-2  hover:bg-emerald-400">
              <Link className="flex items-center">
                <FaAngleRight></FaAngleRight>
                <span className=" font-bold text-lg">Website :</span> www.example.com
              </Link>
            </li>
            ...
            <li className=" list-none  hover:text-emerald-500 hover:scale-105 text-lg  bg-gray-200 rounded-2xl mt-2 ">
              <Link className="flex items-center ">
                <FaAngleRight></FaAngleRight>
                <span className=" font-bold text-lg">Phone :</span> +880 1734174468
              </Link>
            </li>
            ...
            <li className=" list-none  hover:text-emerald-500 hover:scale-105 text-lg  bg-gray-200 hover:bg-red-300 rounded-2xl mt-2">
              <Link className="flex items-center">
                <FaAngleRight></FaAngleRight>
                <span className=" font-bold text-lg">Degree :</span> B.tech in IT
              </Link>
            </li>
  ...
  {[
    ...
    <div key={index} className="bg-white shadow-md rounded-lg p-4">
      <div className="flex justify-between items-center">
        ...
        <p className="font-semibold text-purple-600">{typeof item.level === "number" ? `${item.level}%` : item.level}</p>
      </div>
